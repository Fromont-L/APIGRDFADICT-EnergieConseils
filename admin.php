				...
				<div class="inner-container">
					...
					<form method="post" action="connexion.php" class="center">
						<div class="form-group">
							...
							<input type="text" class="form-control" placeholder="Identifiant" name="myUserNameAdmin"/>
						</div>
						<div class="form-group">
							<label for="password">Entrez votre mot de passe</label>
							<input type="password" class="form-control" placeholder="Mot de Passe" name="myPasswordAdmin"/>
						</div>
